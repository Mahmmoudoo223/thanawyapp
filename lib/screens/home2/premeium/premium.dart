            ...
            Column(
              children: [
                ...
                Padding(
                  ...
                  child: Custom_Text(
                    text: 'يمكنك تفعيل الاشتراك السوبر في التطبيق الان',
                    fontSize: 20,
                ...
                Padding(
                  ...
                  child: Custom_Text(
                    text:
                        'تحصل علي جميع الفيديوهات المدفوعة بشكل مجاني علي هذا الجهاز',
                    fontSize: 13,
                    alignment: Alignment.center,
      ...
      return Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(3.0),
            child: Custom_Text(
              text: 'انت بالفعل مشترك في اشتراك السوبر',
              fontSize: 20,
              alignment: Alignment.center,
            ),
          ),
